...
namespace Magazynier.WinForms
{
    ...
    {
        public delegate void return_article_callback(ItemArticle article);
        public event return_article_callback getData_CallBack;

        private ItemArticle stored_article;
        ...
        public ArticleForm()
        {
            ...
            this.stored_article = new ItemArticle();
        ...
        public ArticleForm(ArticleWindowMode mode, ItemArticle article) : this()
        {
            this.EditMode = mode;
