...
namespace Magazynier.WinForms
{
    ...
    public partial class DocumentForm : Window
    {
        ...
        public DocumentForm(MagDbContext context, DocumentWindowMode mode, ItemDocument doc) : this(context)
        {
        ...
        private void DocumentData_Load(object sender, RoutedEventArgs e)
        {
            if (documentID != 0)
            {
        ...
        private void SelectedContract_getData_CallBack(ItemContract selectedContract)
        {
        ...
        private void btn_SaveDoc(object sender, RoutedEventArgs e)
        {
        ...
        private void SelectedArticle_getData_CallBack(ItemArticle article)
        {
        ...
        private void ArticleUpdate_getData_CallBack(ItemArticle returnedArticle)
        {
            ItemArticle selected = (ItemArticle)dg_DocArticles.SelectedItem;
        ...
        {
            ItemArticle selectedItemArticle = (ItemArticle)dg_DocArticles.SelectedItem;
