...
namespace Magazynier.WinForms
{
    ...
    {
        public delegate void return_contract_callback(ItemContract contract);
        public event return_contract_callback getData_CallBack;

        private ContractWindowMode EditMode;

        private ItemContract stored_contract;
        ...
        public ContractForm(ContractWindowMode mode, ItemContract contract) : this()
        {
            this.EditMode = mode;
